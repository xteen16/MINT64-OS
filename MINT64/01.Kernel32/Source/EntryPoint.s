...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
START:
    mov ax, 0x1000                      ; 보호 모드 엔트리 포인트의 시작 어드레스(0x10000)을
                                        ; 세그먼트 레지스터 값으로 변환
    ...
    mov cr0, eax                        ; CR0 컨트롤 레지스터에서 위에서 저장한 플래그를 설정하여
                                        ; 보호 모드로 전환
...
.MESSAGELOOP:                           ; 메시지 출력 루프
    mov cl, byte [esi]                  ; ESI 레지스터 가리키는 문자열 위치에서 한 문자를
                                        ; CL 레지스터에 복사
                                        ; CL 레지스터는 ECX 레지스터의 하위 1바이트를 의미
                                        ; 문자는 1바이트면 충분하므로 ECX 레지스터 하위 1바이트만 사용
